...
import { Music, Heart, Clock, MapPin, ExternalLink } from 'lucide-react';
                                ...
                                <div className="h-48 w-full relative overflow-hidden">
                                    ...
                                    <div className="absolute -bottom-6 left-1/2 transform -translate-x-1/2">
                                        <span className="inline-block p-4 bg-[#F5F0E6] rounded-full text-[#B08D55] group-hover:bg-[#43342E] group-hover:text-[#F9F4EF] transition-colors duration-500 shadow-md border-4 border-white">
                                            {idx === 0 && <Music size={20} strokeWidth={1.5} />}
                                            {idx === 1 && <Heart size={20} strokeWidth={1.5} />}
                                            {idx === 2 && <Clock size={20} strokeWidth={1.5} />}
                                            {idx > 2 && <MapPin size={20} strokeWidth={1.5} />}
                                        </span>
                                    </div>
                                </div>
